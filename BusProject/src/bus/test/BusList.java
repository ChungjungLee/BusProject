...
public class BusList {
	...
	/**
	 * 정류장 번호를 통해 해당 정류장을 이용하는 버스 목록을 요청한다. (m.bus.go.kr)
	 */
	public void sendRequestBusesByStation2() {
		try {
			String param = "arsId=" + 24143;
			
			BufferedWriter bw = new BufferedWriter(
									new OutputStreamWriter(
										socket2.getOutputStream(), "UTF-8"));
			 
			bw.write("POST /mBus/bus/getStationByUid.do HTTP/1.1\r\n" +
					"Host: " + socket2.getInetAddress() + "\r\n" +
					"Content-Length: " + param.length() + "\r\n" +
					"Accept: application/json, text/javascript, */*; q=0.01\r\n" +
					"Content-Type: application/x-www-form-urlencoded;charset=UTF-8\r\n" + 
					"Cookie: WMONID=Plo3YoSEcx7; JSESSIONID=QRqDgQRgLJcrjIZYM7jwLGmWQOb9S5zlZhuSPF5LfWTSXZOXMGrcEWnbR7uEfUpB.tbms-info2_servlet_Mobile\r\n" +
